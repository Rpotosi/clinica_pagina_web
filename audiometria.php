                    ...
                    <div class="blog-item">
                        <div class="row">  
                            <div class="col-xs-12 col-sm-12 blog-content">
                                    <br>
                                    <h2>AUDIOMETRÍA OCUPACIONAL</h2>
                                    <p class=""> 
                                        Evaluar la agudeza auditiva en un individuo a través de la emisión de señales sonoras
                                        de tonos puros desde un equipo electrónico que registra el mínimo nivel de intensidad
                                        sonora que es percibido por el examinado, para detectar oportunamente posibles pérdidas
                                        auditivas, con el fin de contribuir a prevenir la pérdida auditiva y evitar la progresión cuando ya esté presente.</p>
                               
                                <div class="pull-left">
                                    <a href="#"><img class="media-object" src="images/portfolio/recent/audiometria.jpg" alt=""></a>
                                </div> 
