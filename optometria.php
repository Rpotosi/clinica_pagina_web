                    ...
                    <div class="blog-item">
                        <div class="row">  
                            <div class="col-xs-12 col-sm-12 blog-content">
                                    <br>
                                    <h2>OPTOMETRÍA</h2>
                                    <p>A través de un examen de optometría se logra el cuidado primario de la salud visual, aplicando acciones de prevención, diagnóstico, tratamiento y corrección de defectos refractivos, acomodativos, musculatura ocular y enfermedades. 

                                        Detectar anomalías visuales como la miopía, hipermetropía, astigmatismo, estrabismo.</p>
                                    
                                <div class="pull-left">
                                    <a href="#"><img class="media-object" src="images/portfolio/recent/Opto.jpeg" alt=""></a>
                                </div>                                                                       
                            </div>
                        </div>
                    </div><!--/.blog-item-->
    ...
    <!--Boton chat boot-->
      <section id="boot">
        <div class="contenedor">
                ...
                <button id="btn-abrir-popup" class="btn-abrir-popup">Angente Virtual</button>
            </div>
