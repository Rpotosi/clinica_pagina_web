                    ...
                    <div class="blog-item">
                        <div class="row">  
                            <div class="col-xs-12 col-sm-12 blog-content">
                                   ...
                                   <p>Es una especialidad médica básica, perteneciente al grupo medios de diagnóstico y, como todas ellas resulta indispensable en la actualidad. 
                                    Ayudar a confirmar o descartar un diagnóstico, establecer un pronóstico, controlar la evolución de las enfermedades y los resultados del tratamiento, detectar complicaciones, colaborar con estudios epidemiológicos y de grupos de riesgo y constituir una parte esencial de los protocolos de investigación científica y de los ensayos clínicos para la introducción de nuevos medicamentos.</p>
									
                                <div class="pull-left">
                                    <a href="#"><img class="media-object" src="images/portfolio/recent/clinico.jpg" alt=""></a>
                                </div>                                                                       
                            </div>
                        </div>
                    </div><!--/.blog-item-->
